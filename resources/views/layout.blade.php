...
<head>
    ...
    <title>Fuzz{{ config('app.name') ? ' - ' . config('app.name') : '' }}</title>

    <!-- Style sheets-->
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link href="{{ asset('xqus/laravel-fuzz/css/app.css') }}" rel="stylesheet" type="text/css">
</head>
<body>
<div id="telescope">
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-3"><strong>Fuzz</strong> {{ config('app.name') ? ' - ' . config('app.name') : '' }}</h4>
